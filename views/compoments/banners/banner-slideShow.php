<section class="slider_section slider_two mb-50">
        <div class="slider_area owl-carousel">
            <div class="single_slider d-flex align-items-center" data-bgimg="./asets/client/img/slider/slider10.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="./asets/client/img/slider/slider12.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
